...
import 'package:fashion/pages/fashion/detail_tas.dart';
import 'package:fashion/widgets/big_text.dart';
import 'package:flutter/material.dart';

class DetailT extends StatefulWidget {
  const DetailT({super.key, required Category categories});

  @override
  State<DetailT> createState() => _MainFashionPage();
}

class _MainFashionPage extends State<DetailT> {
  @override
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => Detail_Tas(ListTas: ListTas[index]),
                    ),
                  );
                },
                child: Container(
